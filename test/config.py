...
data_arg.add_argument(
    "--data_te", type=str, default='/home/zyf/dataset/yfcc/yfcc-sift-2000-test.hdf5', help=""
...
filter_arg.add_argument(
    "--model_file", type=str, default="../pretrained-model/sift_yfcc", help=""
    "model file for test")
filter_arg.add_argument(
    "--model_name", type=str, default="model_best.pth", help=""
    "model file for test")
filter_arg.add_argument(
