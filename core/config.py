...
net_arg.add_argument(
    "--grid_nums", type=int, nargs='+', default=[16, 24], help=""
    "number of grids in one domention. Default: [16, 24]")
net_arg.add_argument(
    "--sample_rates", type=float, nargs='+', default=[0.5, 0.5], help=""
    "list of k in down sample. Default: [0.5, 0.5]")
net_arg.add_argument(
    "--up_sample", type=str2bool, default=False, help="change the behavior of adjust to up_sample"
)
net_arg.add_argument(
...
net_arg.add_argument(
    "--att_mode", type=str, default="full", help=""
    "ratio test threshold. Default: 0.8")
...
train_arg.add_argument(
    "--log_suffix", type=str, default="samle[0.5,0.5]-grid[16，24]", help=""
    "suffix of log dir")
train_arg.add_argument(
...
train_arg.add_argument(
    ...
    "use gpu")
train_arg.add_argument(
    "--desc", type=str, default=True, help=""
    "description about current run")
train_arg.add_argument(
